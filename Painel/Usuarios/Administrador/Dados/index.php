        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="images/logo.png"alt="" >APTA </b>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Relatórios</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="#">Quantidade alunos por polo</a></li>
                            <li><a href="#">Quantidade alunos por curso </a></li>
                            <li><a href="#">Quantidade alunos por município</a></li>
                            <li><a href="#">Frequência de alunos por curso </a></li>
                            <li><a href="#">Quantidade professores por polo</a></li>
                            <li><a href="#">Quantidade de alunos total</a></li>
                            <li><a href="#">Quantidade de professores total</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">Alunos</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">Professores</h3>
                                <div class="d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Polos</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">4565</h2>
                                    <p class="text-white mb-0">Jan - March 2019</p>
                                </div>
